...
register_coco_instances("whu_mix_val", {}, json_file="/media/disk3/lmy/dataset/whu-mix/annotations/val-rebox.json",
                        image_root="/media/disk3/lmy/dataset/whu-mix/val/")
